...
public class CodeGenerator {
    ...
    @ResponseBody
    public String codeGenerator(@RequestParam(required = true) String tableNames) {
        // 代码生成器
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3307/one-piece");
